...
自分はその中をけっこう彷徨った。
最終的に**VS Code + Claude Code拡張 + MAXプラン**に落ち着いたが、ここに辿り着くまでに時間もお金もかかった。
...
Pythonでアプリケーションを開発しているが、やっていることは**設計と方針決め**。コードの実装はAIに任せて、出てきたものをレビューする。いわゆるアーキテクト型の開発スタイルだ。
...
コードベース全体を読んで提案してくれるし、チャットでの対話もCopilotより自然。画像も貼れる。しばらくメインで使っていた。課金もけっこうした。
...
Pro時代の「上限来て止まる」ストレスが、Claude Codeの回復サイクルだとかなり緩和される。作業して、休憩して、戻ったらまた使える。自然なリズムで開発が続けられる。
...
**Opusを無限に回しても、なかなか溢れない。** 自分は普通の使い方をしている一般人なので、MAX 5xでも十分すぎるくらい余裕がある。Pro時代の「上限で止まる」が嘘のようだ。
...
<!-- TODO: クオさんに詳細を確認して追記する。翻訳アプリ2つの内容、何を作ったか、Claude Codeでの開発体験を書く -->
