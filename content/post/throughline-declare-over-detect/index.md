...
[前の記事]({{< relref "throughline-context-diet" >}})でThroughlineを公開した。コンテキストの87%を占めてるツールI/Oを退避して、90%圧縮するやつ。
...
## 学び: AIのUXは"明示"のほうが信頼できるかもしれない

最初は「ユーザーが何もしなくても勝手にいい感じに」を目指してた。結果、誤爆が出た。

「ユーザーが明示的に宣言する + AI側が気の利いたメモを残す」に切り替えたら、誤爆ゼロ・体感も向上した。

AIに対するUXって、全自動より、明示と委任の組み合わせの方がいい場面があるのかもしれない。少なくとも自分の使い方ではそうだった。
