...
一番厄介だったのは音声のフィードバックループです。翻訳結果を読み上げると、その読み上げ音声をまたキャプチャして翻訳してしまう。これを防ぐために、プロセス単位で音声をキャプチャする仕組みにしました。

あとは読み上げのタイミングです。翻訳が来るたびに即座に読み上げると動画の音声と被ってうるさい。ダッキング（読み上げ中に動画の音量を自動で下げる）を入れて、自然に聞けるようにしました。
