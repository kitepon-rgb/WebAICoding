...
Claude Code MAXを契約して、毎日のようにコーディングに使っている。
AIキャラクター会話システムをPythonで開発していて、設計は自分でやって実装はClaudeに任せる——いわゆるアーキテクト型の使い方をしている。
...
## `/rc`（Remote Control）— スマホから作業を見守れる
...
自分はAIに作業を任せている間、「今何やってるんだ？」「変なことしてないか？」という不安がある。PCの前にずっと張り付いているのもしんどい。`/rc`があれば、ソファでコーヒー飲みながらスマホで進捗を確認して、おかしな方向に行ってたら止められる。
...
モデル切り替えの存在は知っておいて損はないが、MAXユーザーなら気にしなくていい機能だと思っている。
...
使ってみて良かったこと、ダメだったことをそのまま書く。SEO目的のスカスカ記事は書かない。
