...
![Pro と MAX の機能比較。デフォルトモデル・1Mコンテキスト・優先アクセス・Effort MAX・サブエージェント・Research の6項目で、機能の有無ではなく「使い切れるか」が分かれる](fig1.png)
...
{{< linkcard url="https://support.claude.com/en/articles/11049741-what-is-the-max-plan" title="What is the Max plan?" desc="MAXプランで何が含まれるかの一次ソース。デフォルトモデルや新機能の優先提供について明記されている。" site="Claude Support" >}}
...
![MAX先行リリースのタイムライン。Memory・Cowork・/rc・Dispatch・Computer Use が MAX に先に来て、Pro へは数日〜1ヶ月以上遅れて降りてくる](fig2.png)
