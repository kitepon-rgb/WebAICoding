...
draft: false
description: "Claude本体に頼んで直る問題はもう全部直してて、構造的に直らない問題だけ残ってた。それを外側から補強する3つのツール (Throughline / Caveat / Spotter) を作った話。"
...
- [Throughline]({{< relref "throughline-release" >}}) — コンテキストの肥大化を退避する
- [Caveat]({{< relref "caveat-release" >}}) — 同じ罠を二度踏まないように過去ノートを浮上させる
- [Spotter]({{< relref "spotter-release" >}}) — ツール呼び忘れを別のClaude が監査する
...
これらが「気をつけて」で直らないと判明したら、また外側から補強する。それだけ。
