...
date: 2026-07-25T15:29:00+09:00
draft: false
description: "Claudeに提案されたツールを全部作り、32課題のベンチマークで測り直した。tokenは前回の25.86%減から52.44%減まで行った。"
tags: ["Codex", "AIコーディング", "MCP", "macOS"]
cover:
  image: "cover.png"
---

![作った道具が全部つながった箱を、ストップウォッチと天秤で測っている](eyecatch.png)

[前回の記事]({{< relref "learning-shell-and-terminal-with-aishell" >}})で、自作のAIShellを使うCodexと通常のCodexへ同じ課題を渡して比べたら、tokenが25.86%減った。効果は出そうだと思った。ただ、3課題9試行の結果なので、確信までは持てなかった。
...
![課題別のtoken削減率。プロジェクト構成の把握し直しと待つ場面で7割減、壊れた診断の判定では3割増](fig2.png)
...
![通常のCodexは確認コマンドを繰り返し、AIShellは1回頼んで知らせを待つ](fig1.png)
