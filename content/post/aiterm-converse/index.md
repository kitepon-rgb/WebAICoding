...
draft: false
description: "Claudeに別のAI（Codex・Grok・Composer）を会話させて動かす。対話型ターミナルをそのままAIに握らせる、aiterm-mcpの今の使い方。"
tags: ["Claude Code", "MCP", "オーケストレーション", "OSS"]
cover:
  image: "cover.png"
---
...
![Claude が握る1本の端末の中で Codex を起動し、画面を読んでは次を送る。この読む↔送るの往復が会話。Grok・Composer も同じやり方で起動できる](converse.png)
