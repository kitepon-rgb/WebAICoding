...
{{< linkcard url="https://github.com/kitepon-rgb/Lattice" title="kitepon-rgb/Lattice" desc="作業がコードのどこを触るかを見積もって、並列で走らせられる工程を組む道具。重なりはリファクタで切り離してから配る。ソース公開。商用利用には事前の許諾が必要。" site="GitHub" >}}
