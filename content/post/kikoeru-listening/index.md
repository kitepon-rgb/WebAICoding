...
draft: false
description: "AIを使って開発してると、大事な情報は英語に偏ってると痛感する。最新の発表は英語オンリーも多い。英語は読めるのに、聞き取れない——中学レベルの英文ですら耳だと掴めない。聞き取りの鍛え方を調べるうちに気づいた。AIを使えば、自分に合った教材は無限に作れる。そこから iPhone のリスニングアプリ Kikoeru を作って App Store に出すまでの記録。"
tags: ["個人開発", "Claude Code", "AIコーディング", "iOSアプリ", "英語学習"]
cover:
  image: "cover.png"
---
...
![読めるのに、聞こえない。その一点を埋めたかった。](eyecatch.png)
...
![音だけ → 答え合わせ → 字幕つき。この3周で「聞こえる音」を「意味のわかる音」に変える。](flow.png)
...
![アカウント登録なしで入れて、学年を選べばすぐ始められる。進捗も設定も端末の中だけに残る。](screens.png)
...
{{< linkcard url="https://apps.apple.com/jp/app/id6778238379" title="Kikoeru — 中学英語からの聞き取りリスニング" desc="聞こえる音が、聞き取れる音になる。音だけ→答え合わせ→字幕つき。中1ぶんは無料。" site="App Store" image="appicon.png" >}}
