...
emoji: "🏭"
type: "tech"
topics: ["githubactions", "ci", "aicoding", "windows", "個人開発"]
published: true
---
...
![試験内容は自分たちが決め、GitHubが仕事を配り、GitHubの仮想マシンや登録した自宅端末が実行する](https://kitepon.dev/blog/post/what-is-ci/ci-roles.png)
*試験内容は自分たちが決め、GitHubが仕事を配り、GitHubの仮想マシンや登録した自宅端末が実行する*
...
Latticeを作った経緯と仕組みは「[AIを並列で走らせる道具を作ったら、AIが嘘をつかなくなった話](https://kitepon.dev/blog/post/lattice-parallel-agents/)」で詳しく書いている。
...
![自宅のMac、Linuxサーバー、高性能なWindowsマシンが同時に試験を実行しているイメージ](https://kitepon.dev/blog/post/what-is-ci/home-ci-machines.png)
*自宅のMac、Linuxサーバー、高性能なWindowsマシンが同時に試験を実行しているイメージ*
...
![GitHub Actionsから自宅のMac、Linux、Windows native、WSL2へ同じフルテストを同時に配る](https://kitepon.dev/blog/post/what-is-ci/four-environments.png)
*GitHub Actionsから自宅のMac、Linux、Windows native、WSL2へ同じフルテストを同時に配る*
